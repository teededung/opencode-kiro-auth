...
export async function withInProcessLock(fn) {
    let resolveInProcess;
    const prev = inProcessLockChain;
    inProcessLockChain = new Promise((r) => (resolveInProcess = r));
    await prev;
